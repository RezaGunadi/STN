                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="client_search" placeholder="Cari client..." @if ($event) value="{{ $event->clientData->name }}" @endif>
                                <input type="hidden" id="client" name="client" required @if ($event) value="{{ $event->client }}" @endif>
                            </div>
                            @error('client')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="starter_team_search" @if ($event) value="{{ $event->starterTeam->name }}" @endif
                                    placeholder="Cari tim starter...">
                                <input type="hidden" id="starter_team" name="starter_team" @if ($event) value="{{ $event->starter_team }}" @endif>
                            </div>
                            @error('starter_team')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="closer_team_search" @if ($event) value="{{ $event->closerTeam->name }}" @endif
                                    placeholder="Cari tim closer...">
                                <input type="hidden" id="closer_team" name="closer_team" @if ($event) value="{{ $event->closer_team }}" @endif>
                            </div>
                            @error('closer_team')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
