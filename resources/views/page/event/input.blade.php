...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Input Event') }}
                </div>
                {{-- product_code
product_name
category
                ...
                <div class="card-body">
                    <form action="{{ route('submit_event') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @endif class="form-control @error('event_name') is-invalid @enderror" required
                                id="event_name" name="event_name" placeholder="Dufan fun Play">
                            @error('event_name')
                        ...
                        <div class="mb-3">
                            ...
                            @endif class="form-control @error('event_location') is-invalid @enderror"
                                required id="event_location" name="event_location" placeholder="Dufan Jakarta">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" @if ($event)
                                value="{{ $event->lng }}"
                            @endif class="form-control @error('lng') is-invalid @enderror" required id="lng"
                                name="lng" placeholder="Samsung">
                            @error('lng')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" @if ($event)
                                value="{{ $event->client }}"
                            @endif class="form-control @error('client') is-invalid @enderror" required
                                id="client" name="client" placeholder="PT. XYZ">
                            @error('client')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
